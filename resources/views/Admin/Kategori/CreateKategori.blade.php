                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input class="form-control @error('nm_kategori') is-invalid @enderror" type="text" name="nm_kategori" id="nm_kategori" value="{{ old('nm_kategori') }}" placeholder="Masukkan Nama Kategori">
                            @error('nm_kategori')
